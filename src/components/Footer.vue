<template>
    <div class="foot-btn" >
    <ul>
      <router-link tag="li" class="home" to="/home" active-class="home--active"><a href="javascript:;" ></a></router-link>
      <router-link tag="li" class="write" to="/buycar" active-class="write--active"><a href="javascript:;" ></a></router-link>
      <router-link tag="li" class="my" to="/user" active-class="my--active"><a href="javascript:;" ></a></router-link>
    </ul>
  </div>
</template>
