<template>
    ...
    <div class="content" v-if="data.detail">
      <div class="header clear"><h2><img :src="server + data.detail.auth_icon" alt=""/></h2><p>{{data.detail.auth}}</p></div>
      <div class="cont">
        <h3>{{data.title}}</h3>
        <div class="time"><p>{{data.time}}<span><img src="../assets/img/zan.png" alt=""/></span></p></div>
