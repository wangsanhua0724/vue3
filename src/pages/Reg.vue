...
<style scoped>
  ...
  .content ul li input{ padding-left:1rem;width:4.54rem;height:100%; font-size:0.4rem;}
  .content ul li span{width:1.23rem;height:0.49rem; position:absolute;top:0.26rem;left:0; color:#676868; font-size:0.25rem; line-height:0.49rem; text-align:center;}
